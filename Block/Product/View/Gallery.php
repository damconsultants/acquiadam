...
namespace DamConsultants\AcquiaDam\Block\Product\View;
...
class Gallery extends \Magento\Catalog\Block\Product\View\Gallery
{
    ...
    public function getGalleryImagesJson()
    {
        ...
        $use_acquiadam_cdn = $product->getUseWidenCdn();
        $use_acquiadam_both_image = $product->getUseWidenBothImage();
        $acquiadam_image = $product->getWidenMultiImg();
        $imagesItems = [];
        $role_image = 0;
        ...
        } elseif ($use_acquiadam_cdn == 1) { /*CDN Image*/
            if (!empty($acquiadam_image)) {
                $json_value = json_decode($acquiadam_image, true);
                $role_image = 0;
				usort($json_value, function ($a, $b) {
