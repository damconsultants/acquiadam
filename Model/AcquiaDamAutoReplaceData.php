...
class AcquiaDamAutoReplaceData extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init(\DamConsultants\AcquiaDam\Model\ResourceModel\AcquiaDamAutoReplaceData::class);
    }
}
