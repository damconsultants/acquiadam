...
namespace DamConsultants\AcquiaDam\Model\Config;
...
class CronConfig extends \Magento\Framework\App\Config\Value
{
    ...
    public function afterSave()
    {
        ...
        $every_min =  \DamConsultants\AcquiaDam\Model\Config\Source\Frequency::EVERY_TEN_TIME;
        if ($frequency == $every_min) {
            ...
            $cronExprArray = [
                (int)$time[1], /* Minute */
                (int)$time[0], /* Hour */
                $frequency == \DamConsultants\AcquiaDam\Model\Config\Source\Frequency::CRON_MONTHLY ?
                '1' : '*', /* Day of the Month */
                '*', /* Month of the Year */
                $frequency == \DamConsultants\AcquiaDam\Model\Config\Source\Frequency::CRON_WEEKLY ?
                '1' : '*', /* Day of the Week */
            ];
        }
